...
class NeuralController:
    ...
    def calculateAction(self, shortestPillDistance,shortestGhostDistance, eatableGhost, ghost):
        result = self.net.activate([shortestPillDistance,shortestGhostDistance, eatableGhost, ghost])
        return result[0]
